...
@[Link(ldflags: "-Wl,--whole-archive -Wl,--start-group -lrte_pci -lrte_bus_pci -lrte_mempool -lrte_mempool_ring -lrte_ring -lrte_ethdev -lrte_eal -lrte_mbuf -Wl,--end-group -Wl,--no-whole-archive -lnuma -ldl -lpthread -lm #{__DIR__}/../ext/libdpdk.a")]
lib LibDpdk
...
require "../lib_dpdk/lib_rte_hexdump.cr"
...
require "../lib_dpdk/lib_rte_ether.cr"
