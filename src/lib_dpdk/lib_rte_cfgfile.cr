lib LibDpdk
  ...
  fun rte_cfgfile_add_entry(cfg : RteCfgfile*, sectionname : LibC::Char*, entryname : LibC::Char*, entryvalue : LibC::Char*) : LibC::Int
  fun rte_cfgfile_add_section(cfg : RteCfgfile*, sectionname : LibC::Char*) : LibC::Int
  fun rte_cfgfile_close(cfg : RteCfgfile*) : LibC::Int
  fun rte_cfgfile_create(flags : LibC::Int) : RteCfgfile*
  ...
  fun rte_cfgfile_save(cfg : RteCfgfile*, filename : LibC::Char*) : LibC::Int
  ...
  fun rte_cfgfile_section_num_entries_by_index(cfg : RteCfgfile*, sectionname : LibC::Char*, index : LibC::Int) : LibC::Int
  fun rte_cfgfile_sections(cfg : RteCfgfile*, sections : LibC::Char**, max_sections : LibC::Int) : LibC::Int
  fun rte_cfgfile_set_entry(cfg : RteCfgfile*, sectionname : LibC::Char*, entryname : LibC::Char*, entryvalue : LibC::Char*) : LibC::Int
