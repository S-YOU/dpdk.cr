lib LibDpdk
  ...
  fun rte_pdump_disable(port : Uint16T, queue : Uint16T, flags : Uint32T) : LibC::Int
  fun rte_pdump_disable_by_deviceid(device_id : LibC::Char*, queue : Uint16T, flags : Uint32T) : LibC::Int
  fun rte_pdump_enable(port : Uint16T, queue : Uint16T, flags : Uint32T, ring : RteRing*, mp : RteMempool*, filter : Void*) : LibC::Int
