...
LDFLAGS += -std=c++14 -static-libgcc --param max-inline-insns-single=10000 -finline-functions -fPIE -pie -m64 -pthread -march=native -mssse3 -Wl,--no-as-needed -Wl,-export-dynamic -L$(DPDK_PATH)/lib -lnuma -lpthread -ldl -lrt -lm -lgc -levent -levent_pthreads -lpcre $(if $(release),-O3 -Ofast )
